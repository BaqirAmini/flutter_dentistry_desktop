...
class HealthHistories extends StatefulWidget {
  ...
  @override
  State<HealthHistories> createState() => _HealthHistoriesState();
}

class _HealthHistoriesState extends State<HealthHistories> {
                                  ...
                                  Expanded(
                                    ...
                                    child: Theme(
                                      ...
                                      child: RadioListTile(
                                        ...
                                        value: 1,
                                        groupValue: _condResultGV[cond.condID],
                                        onChanged: (int? value) {
                                          setState(
                                            () {

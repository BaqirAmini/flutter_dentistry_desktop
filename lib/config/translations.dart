final Map<String, Map<String, String>> translations = {
  'English': {
    ...
    'SchdAppt' : 'Schedule an Appointment',
    ...
    'CondirmSchedDelete' : 'Are you sure you want to delete the scheduled appointment?',
    'SchedApptDeleted' : 'The scheduled appointment deleted.',
    'DupPatient' : 'Patient with the same phone number already exists in the system.',
  ...
  'پښتو': {
    ...
    'CondirmSchedDelete' : 'ایا تاسو ډاډه یاست چې تاسو غواړئ ټاکل شوی ملاقات حذف کړئ؟',
